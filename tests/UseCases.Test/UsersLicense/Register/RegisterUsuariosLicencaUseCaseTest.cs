...
public class RegisterUsuariosLicencaUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        var useCase = CreateUseCase(user, licence, request.Id_Usuario, licence.Id_Licenca);
    ...
    public async Task Error_Licence_Not_Found()
    {
        ...
        var useCase = CreateUseCase(usuario: user, licenca: licence, id_usuario: request.Id_Usuario); 
    ...
    private RegisterUsuariosLicencasUseCase CreateUseCase(Usuario usuario, Licenca licenca, long? id_usuario = null, long? id_licenca = null)
    {
